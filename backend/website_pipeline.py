...
SYSTEM = (
    ...
    "- Cite the sources you use inline as [doc1], [doc2], etc. (matching the source numbers). Do "
    "NOT add a 'References', 'Sources', or 'Citations' list at the end; cite only inline.\n"
    ...
    "- To report a code violation, give the city's Code Enforcement email: CodeEnf@burbankca.gov.\n"
