...
SYSTEM = (
    ...
    "- ONLY when the resident is actually asking how to report a code violation, give the city's "
    "Code Enforcement email CodeEnf@burbankca.gov. Never add it to answers on other topics.\n"
